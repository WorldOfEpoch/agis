...
import atavism.server.marshalling.*;
...
public class DCMap implements Serializable, Marshallable {
    ...
    Map<DisplayContext, DisplayContext> map = 	new HashMap<DisplayContext, DisplayContext>();
    private final transient Lock lock = LockFactory.makeLock("DCMap");
